package com.ruisu.hamptonemicroservicelisting.security;
...
public class SecurityConfig {
    ...
    @Value("${service.security.source-key-username}")
    private String SECURE_KEY_USERNAME;

    @Value("${service.security.source-key-password}")
    private String SECURE_KEY_PASSWORD;

    @Value("${service.security.source-key-username-2}")
    private String SECURE_KEY_USERNAME_2;

    @Value("${service.security.source-key-password-2}")
